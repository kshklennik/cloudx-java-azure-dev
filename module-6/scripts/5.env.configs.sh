...
FUNCTION_ORDER_REGISTER_URL="https://order-items-register.nicemushroom-38e5e243.eastus2.azurecontainerapps.io"
...
az containerapp update \
  ...
  --set-env-vars \
  PETSTOREPRODUCTSERVICE_URL=$PRODUCT_URL \
  PETSTOREREGISTERSERVICE_URL=$FUNCTION_ORDER_REGISTER_URL
